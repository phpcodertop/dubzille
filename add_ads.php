    ...
    <div class="u-c u-c--12o12">
        ...
        <div class="u-r ">
            <div id="page-title" class="u-c u-c--12o12">
                <h1>إختر القسم المناسب لإعلانك</h1>
...
{
?> 
<a href="add_ads2.php?category_id=<?=$result['ID']?>" title="<?=$result['address']?>" >
<div style="float:right;margin:1rem;width:30.33333%;padding:15px;background-color:#3f80A3;height:130px;text-align:center;color:#fff;line-height:110px;">
<?=$result['address']?>
</div>
</a>
<?php
