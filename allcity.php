...
<?
include_once("allcity_right.php");
?> 
...
اعلان
	...
	*/
	$country_id=$_GET['country_id'];
	$query = "SELECT COUNT(*) as num FROM ads where country_id=$country_id  and  status='موافقة' ";
	$total_pages = mysql_fetch_array(mysql_query($query));
	$total_pages = $total_pages[num];
	
	/* Setup vars for query. */
	$targetpage = "allcity.php?country_id=$country_id"; 	//your file name  (the name of this file)
	...
	$sql = "SELECT * FROM ads where country_id=$country_id  and  status='موافقة' order by ID desc LIMIT $start,$limit ";
