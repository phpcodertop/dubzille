...
وجدنا
<?
$deecount=mysql_query("select COUNT(ID) as ads_count FROM  ads where address LIKE ('$partaddress%') and  country_id='$country_id' and  status='موافقة' ");
...
اعلان
	...
	*/
	$partaddress=$_GET['partaddress'];
	$query = "SELECT COUNT(*) as num FROM ads where address LIKE ('$partaddress%') and  country_id='$country_id' and  status='موافقة' ";
	$total_pages = mysql_fetch_array(mysql_query($query));
	$total_pages = $total_pages[num];
	
	/* Setup vars for query. */
	$targetpage = "result_search.php?partaddress=$partaddress"; 	//your file name  (the name of this file)
	...
	$sql = "SELECT * FROM ads where address LIKE ('$partaddress%') and  country_id='$country_id' and  status='موافقة' order by ID desc LIMIT $start,$limit ";
