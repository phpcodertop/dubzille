...
وجدنا
<?
$deecount=mysql_query("select COUNT(ID) as ads_count FROM  ads where email='$customer_email' and  status='موافقة' ");
...
اعلان
	...
	*/
	$cat_id=$_GET['cat_id'];
	$query = "SELECT COUNT(*) as num FROM ads where email='$customer_email' and  status='موافقة' ";
	$total_pages = mysql_fetch_array(mysql_query($query));
	$total_pages = $total_pages[num];
	
	/* Setup vars for query. */
	$targetpage = "customer_allads.php"; 	//your file name  (the name of this file)
	...
	$sql = "SELECT * FROM ads where email='$customer_email' and  status='موافقة' order by ID desc LIMIT $start,$limit ";
